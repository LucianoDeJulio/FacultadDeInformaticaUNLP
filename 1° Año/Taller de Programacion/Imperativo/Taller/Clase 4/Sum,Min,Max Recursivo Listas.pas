{Actividad 11:En el programa ListaRecursiva:

a- Implementar un modulo recursivo maximo que devuelva el maximo valor de la lista.

b- Implementar un modulo recursivo minimo que devuelva el maximo valor de la lista.

c- Implementar un modulo recursivo buscar que devuelva verdadero si un valor
determinado se encuentra en la lista o falso en caso contrario.}
