...
a)- Implementar el modulo Min que recibe un arbol y devuelve el valor minimo. En
caso de recibir un arbol vacio, retornar -1.

b)- Implementar el modulo Max que recibe un arbol y devuelve el valor maximo. En
caso de recibir un arbol vacio, retornar -1.

c)- Invocar a los modulos generados. Mostrar los resultados obtenidos.}
